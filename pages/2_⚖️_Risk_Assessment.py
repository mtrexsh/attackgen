...
st.set_page_config(
    page_title="Generate Risk Assessment",
    page_icon="⚖️",
)
...
st.markdown(
    "# <span style='color: #1DB954;'>Security Assessment 🛡️</span>",
    unsafe_allow_html=True,
)

st.markdown(
    """
    This tool helps you assess the security of your system or application. 
...
try:
    ...
    system_template = """You are a cybersecurity expert. Analyze the provided information and generate a security risk assessment that includes:
    ...
    Focus on actionable recommendations based on the provided information."""
    ...
    Please provide a security assessment based on this information."""
...
try:
    if model_provider == "Azure OpenAI Service":
        if st.button("Generate Assessment", key="generate_custom_scenario_azure"):
        ...
        if st.button("Generate Assessment", key="generate_custom_scenario_google"):
        ...
        if st.button("Generate Assessment", key="generate_custom_scenario_mistral"):
        ...
        if st.button("Generate Assessment", key="generate_custom_scenario_ollama"):
        ...
        if st.button("Generate Assessment", key="generate_custom_scenario_groq"):
        ...
        if st.button("Generate Assessment", key="generate_custom_scenario_custom"):
        ...
        if st.button("Generate Assessment", key="generate_custom_scenario"):
